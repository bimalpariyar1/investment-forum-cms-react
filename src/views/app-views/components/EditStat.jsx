...
const EditStat = (props) => {
  ...
  const submitHandler = (values) => {
    ...
    let formData = {
      ...
      cardNumber_ar: values.cardNumber_ar,
    ...
    axios
      ...
      .then((res) => {
        if (res.data && res.data.data) {
          res.data.data.id = editable.id;
          props.setStats &&
            props.setStats(
              props.stats.map((stat) => {
                if (stat.id === res.data.data.id) {
    ...
    <>
      {currentPop !== null && (
        <Formik
          ...
          initialValues={{
            cardTitle_en: currentPop.cardTitle_en,
            cardTitle_ar: currentPop.cardTitle_ar,
            cardDesc_en: currentPop.cardDesc_en,
            cardDesc_ar: currentPop.cardDesc_ar,
            cardNumber_en: currentPop.cardNumber_en,
            cardNumber_ar: currentPop.cardNumber_ar,
            postFix: currentPop.postFix,
            postFixAr: currentPop.postFixAr,
            preFix: currentPop.preFix,
            preFixAr: currentPop.preFixAr,
          }}
        >
          {({
            handleSubmit,
